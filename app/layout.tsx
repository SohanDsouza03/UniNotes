...
export const metadata: Metadata = {
  ...
  title:
    "UniNotes - Your one stop solution for Notes, PYQ's, FlashCards, Quiz and More!",
  description:
    "Discover the power of efficient learning with UniNotes, the one-stop solution for comprehensive notes, previous year questions (PYQs), flashcards, quizzes, and more! Rated by 100+ students from 100+ colleges, UniNotes simplifies complex concepts, provides AI-powered answers, and organizes resources by year and semester for fast, smart, and effective exam preparation. Whether you're in your first year or final year, find all the resources you need to excel in your studies. Join the smarter way to learn!",
  keywords: [
    "UniNotes",
    "Study smarter",
    "Engineering notes",
