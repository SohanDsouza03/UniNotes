    ...
    <div className="p-6 flex flex-col space-y-6 text-left container mx-auto max-w-3xl font-wotfard">
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          use of UniNotes’s website and services. By accessing or using our
      ...
      <section className="mb-6">
        ...
        <p>
          ...
          for safeguarding your account credentials. UniNotes is not liable
      ...
      <section className="mb-6">
        ...
        <p>
          The notes and resources shared on UniNotes are either
          user-contributed or owned by UniNotes. By uploading materials, you
      ...
      <section className="mb-6">
        ...
        <p>
          UniNotes offers free and paid subscription tiers. By subscribing to
      ...
      <section className="mb-6">
        ...
        <p>
          UniNotes is not responsible for inaccuracies in user-contributed
