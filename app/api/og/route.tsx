...
export async function GET(req: NextRequest) {
  try {
    ...
    if (!title) {
      return new Response("UniNotes", { status: 500 });
    }
    const heading =
      ...
      (
        <div tw="flex flex-col p-12 w-full h-full items-start text-black bg-white">
          <div tw="flex flex-col mb-6">
            <div tw="flex items-center">
              <img
                ...
                tw="w-10 h-10"
              />
              <p tw="ml-4 font-bold text-3xl">UniNotes</p>
            </div>
          ...
          <div tw="flex items-center w-full justify-between">
            <div tw="flex text-xl">
              <span>A website by sohandsouza03 | web: ramx.in</span>
            </div>
            <div tw="flex items-center text-xl">
              <div tw="flex ml-2">
                ...
                <span>github.com/sohandsouza03</span>
              </div>
            </div>
          </div>
        </div>
